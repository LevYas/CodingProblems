...
{
    public class BipartitionsFinder_IsGraphBipartite
    {
        [Theory]
        ...
        public static TheoryData<int[][], bool> ArrsForBipartitionCheck
            => new TheoryData<int[][], bool>
            {
                ...
                {
                    new[] { new[] { 1, 2, 3 }, new[] { 0, 2 }, new[] { 0, 1, 3 }, new[] { 0, 2 }, },
                    false
                },
                {
                    new[] { new[] { 4, 5 }, new[] { 2 }, new[] { 1 }, Array.Empty<int>(), new[] { 0 }, new[] { 0 },},
                    true
                },
                {
                    new[] { new[] { 4, 5 }, new[] { 3, 4, 5 }, new[] { 4 }, new[] { 1 }, new[] { 0, 1, 2 }, new[] { 0, 1 },},
                    true
                },
                {
                    new[] { new[] { 4, 5 }, new[] { 3, 4, 5 }, new[] { 4 }, new[] { 1 }, new[] { 0, 1, 2, 5 }, new[] { 0, 1, 4 },},
                    false
                },
            };
